...
resource nic 'Microsoft.Network/networkInterfaces@2021-08-01' = {
  name: 'alz-tst-vm-008-nic' //// update /////
  location: location
  properties: {
    ipConfigurations: [
      {
...
param virtualMachineName string = 'alz-tst-vm-008' //// update ////
param networkInterfaceId string = '/subscriptions/0b6bba99-c2d7-4f8b-b9d2-a0b54c6d046f/resourceGroups/alz_tst_rg_001/providers/Microsoft.Network/networkInterfaces/alz-tst-vm-008-nic' //// update ////
